...
fig1.update_layout(title="Number of Transfers & Users Over Time", yaxis=dict(title="Number of Transfers"), yaxis2=dict(title="Number of Users", overlaying='y', side='right'))
...
fig2.update_layout(title="Volume of Interchain Transfers Over Time", yaxis=dict(title="Volume ($AI)"), yaxis2=dict(title="Volume ($USD)", overlaying='y', side='right'))
...
fig3.update_layout(title="Interchain Transfer Fees Over Time", yaxis=dict(title="Total Fees ($USD)"), yaxis2=dict(title="Median Fees ($USD)", overlaying='y', side='right'))
